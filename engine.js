...
(function (root, factory) {
  ...
  const LIBRARY = [
    // ---- Chest
    ex("Bench Press (Dumbbell)", "compound", "chest", ["triceps", "front delt"], "dumbbell", 2.5, ["chest_press"], ["backchest", "push"], ["Barbell Bench Press", "Machine Chest Press"]),
    ex("Barbell Bench Press", "compound", "chest", ["triceps", "front delt"], "barbell", 5, ["chest_press"], ["backchest", "push"], ["Bench Press (Dumbbell)", "Machine Chest Press"]),
    ex("Machine Chest Press", "compound", "chest", ["triceps"], "machine", null, ["chest_press"], ["backchest", "push"], ["Barbell Bench Press", "Bench Press (Dumbbell)"]),
    ...
    ex("Decline Dumbbell Bench Press", "compound", "chest", ["triceps"], "dumbbell", 2.5, ["chest_press"], ["push", "backchest"], ["Bench Press (Dumbbell)", "Machine Chest Press"]),
    ...
    ex("Weighted Dips", "compound", "chest", ["triceps"], "bodyweight", 2.5, ["chest_press", "triceps_iso"], ["push", "backchest"], ["Machine Chest Press", "Close-Grip Bench Press"]),
    ...
    ex("Straight-Arm Cable Pullovers", "isolation", "lats", [], "cable", null, ["back_secondary"], ["pull", "backchest"], ["Neutral-Grip Lat Pulldowns", "Dumbbell Rows"], { vtaper: true }),
    ...
    ex("Face Pulls", "isolation", "rear delt", [], "cable", null, ["rear_delt"], ["pull", "backchest"], ["Cable Face Pulls", "Rear Delt Reverse Fly (Machine)"]),
    ex("Cable Face Pulls", "isolation", "rear delt", [], "cable", null, ["rear_delt"], ["pull", "backchest"], ["Face Pulls", "Rear Delt Dumbbell Flyes"]),
    ex("Rear Delt Reverse Fly (Machine)", "isolation", "rear delt", [], "machine", null, ["rear_delt"], ["pull", "backchest"], ["Rear Delt Dumbbell Flyes", "Cable Face Pulls"]),
    ex("Rear Delt Dumbbell Flyes", "isolation", "rear delt", [], "dumbbell", 2.5, ["rear_delt"], ["pull", "backchest"], ["Rear Delt Reverse Fly (Machine)", "Cable Face Pulls"]),
    ex("Incline Dumbbell Y-Raises", "isolation", "rear delt", ["lower trap"], "dumbbell", 2.5, ["rear_delt"], ["pull", "backchest"], ["Face Pulls", "Rear Delt Dumbbell Flyes"]),
    ...
    ex("EZ-Bar Skull Crushers", "isolation", "triceps", [], "barbell", 5, ["triceps_iso"], ["arms", "push"], ["Overhead Dumbbell Extensions", "Close-Grip Bench Press"]),
    ex("Close-Grip Bench Press", "compound", "triceps", ["chest"], "barbell", 5, ["triceps_iso", "chest_press"], ["arms", "push", "backchest"], ["EZ-Bar Skull Crushers", "Weighted Dips"]),
  ...
  const SESSIONS = {
    arms: {
      ...
      kind: "weekday",
      slots: [
        { role: "biceps_heavy", band: "weekday_main", label: "Heavy biceps" },
        ...
        { role: "lateral_delt", band: "lateral_delt", label: "Lateral delt", ld: true },
      ],
    },
    legs: {
      label: "Legs",
    ...
    backchest: {
      ...
      kind: "weekday",
      slots: [
        { role: "back_vertical", band: "weekday_main", label: "Heavy back compound", warmup: true },
        { role: "chest_press", band: "weekday_main", label: "Heavy chest press" },
        { role: "back_secondary", band: "isolation", label: "Secondary back — new angle", distinctFrom: 0 },
        { role: "lateral_delt", band: "lateral_delt", label: "Lateral delt", ld: true },
      ],
    },
    push: {
      ...
      kind: "weekend",
      slots: [
        { role: "chest_press", band: "weekend_main", label: "Chest press — volume", warmup: true },
        { role: "chest_iso", band: "isolation", label: "Chest isolation" },
        { role: "lateral_delt", band: "lateral_delt", label: "Lateral delt", ld: true },
        { role: "triceps_iso", band: "isolation", label: "Triceps isolation" },
    ...
    pull: {
      ...
      kind: "weekend",
      slots: [
        { role: "back_vertical", band: "weekend_main", label: "Vertical pull — volume", warmup: true },
        { role: "back_horizontal", band: "weekend_main", label: "Horizontal pull — volume" },
        { role: "biceps_iso", band: "isolation", label: "Biceps 1" },
        { role: "biceps_iso", band: "isolation", label: "Biceps 2 — vary grip", distinctFrom: 2 },
        { role: "biceps_iso", band: "isolation", label: "Biceps 3 — vary implement", distinctFrom: 3 },
        { role: "ab_flexion", band: "ab_weighted", label: "Weighted ab — flexion" },
        { role: "ab_lower", band: "ab_lower", label: "Lower abs" },
      ],
    },
